...
pub fn make_world() -> (geometry::Camera, BvhNode) {
    ...
    let ground = Box::new(make_sphere(Point3::new(0., -10000., 0.), 10000., Arc::new(materials::Lambertian::new(Vector3::new(127., 127., 127.)))));
    world.push(ground);
        ...
        for b in -11..11 {
            ...
            if (center - Point3::new(4., 0.2, 0.)).norm() > 0.9 {
                ...
                if mat < 0.6 { // matte
                    ...
                    world.push(Box::new(make_sphere(center, 0.2, Arc::new(materials::Lambertian::new(color)))));
                    ...
                    world.push(Box::new(make_sphere(center, 0.2, Arc::new(materials::Metal::new(color, util::rand_range(0., 0.5))))));
                } else { // glass
                    world.push(Box::new(make_sphere(center, 0.2, Arc::new(materials::Dielectric::new(util::rand_range(1.2, 1.8))))));
                }
            }
        }
    }

    world.push(Box::new(make_sphere(Point3::new(0., 1., 0.), 1., Arc::new(materials::Dielectric::new(1.5)))));
    world.push(Box::new(make_sphere(Point3::new(-4., 1., 0.), 1., Arc::new(materials::Lambertian::new(Vector3::new(102., 51., 25.))))));
    world.push(Box::new(make_sphere(Point3::new(4., 1., 0.), 1., Arc::new(materials::Metal::new(Vector3::new(178.5, 153., 127.5), 0.05)))));
        ...
        for b in -11..11 {
            ...
            if (center - Point3::new(4., 0.2, 0.)).norm() > 0.9 {
                ...
                if mat < 0.75 { // matte
                    ...
                    let color: Vector3<f64> = Vector3::new(255. * util::rand() * util::rand_range(0.4, 0.8), 255. * util::rand() * util::rand_range(0.4, 0.8), 255. * util::rand() * util::rand_range(0.4, 0.8));
                    world.push(Box::new(make_moving_sphere(center, center2, 0., 1., 0.2, Arc::new(materials::Lambertian::new(color)))));
...
pub fn sphere_cat_bvh() -> (geometry::Camera, BvhNode) {
    ...
    let sphere = make_sphere(Point3::new(70., -20., 10.), 50., Arc::new(materials::Metal::new(Vector3::new(178.5, 153., 127.5), 0.)));
    let other = make_sphere(Point3::new(0., -1000., 0.), 950., Arc::new(materials::Metal::new(Vector3::new(128., 153., 150.), 0.1)));
