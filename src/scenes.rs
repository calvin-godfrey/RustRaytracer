...
pub fn make_world() -> (geometry::Camera, BvhNode, Vec<Primitive>, Vec<Material>, Vec<Texture>) {
    ...
    let other_mat = Material::new_dielectric(1.5);
    materials.push(other_mat);
...
// #[allow(dead_code)]
// pub fn make_world_moving() -> (geometry::Camera, BvhNode, Vec<Primitive>) {
//     let from: Point3<f64> = Point3::new(13., 2.,3.);
//     let to: Point3<f64> = Point3::new(0., 0., 0.0);
//     let up: Vector3<f64> = Vector3::new(0., 1., 0.);
...
//     let mut world: Vec<Primitive> = Vec::new();
//     let ground = Primitive::new_sphere(Point3::new(0., -10000., 0.), 10000., Arc::new(Material::new_lambertian(Texture::new_checkered(Box::new(Texture::new_solid_color(Vector3::new(201., 201., 201.))), Box::new(Texture::new_solid_color(Vector3::new(51., 75.5, 25.5))), 10.))));
//     world.push(ground);
...
//                     let color: Vector3<f64> = Vector3::new(255. * util::rand() * util::rand_range(0.4, 0.8), 255. * util::rand() * util::rand_range(0.4, 0.8), 255. * util::rand() * util::rand_range(0.4, 0.8));
//                     world.push(Primitive::new_moving_sphere(center, center2, 0., 1., 0.2, Arc::new(Material::new_lambertian(Texture::new_solid_color(color)))));
//                 } else if mat < 0.92 { // metal
//                     let color: Vector3<f64> = Vector3::new(util::rand_range(30., 200.), util::rand_range(30., 200.), util::rand_range(30., 200.));
//                     world.push(Primitive::new_sphere(center, 0.2, Arc::new(Material::new_metal(color, util::rand_range(0., 0.5)))));
//                 } else { // glass
//                     world.push(Primitive::new_sphere(center, 0.2, Arc::new(Material::new_dielectric(util::rand_range(1.2, 1.8)))));
//                 }
//             }
//         }
//     }

//     world.push(Primitive::new_sphere(Point3::new(0., 1., 0.), 1., Arc::new(Material::new_dielectric(1.5))));
//     world.push(Primitive::new_sphere(Point3::new(-4., 1., 0.), 1., Arc::new(Material::new_lambertian(Texture::new_solid_color(Vector3::new(102., 51., 25.))))));
//     world.push(Primitive::new_sphere(Point3::new(4., 1., 0.), 1., Arc::new(Material::new_metal(Vector3::new(178.5, 153., 127.5), 0.05))));
...
// #[allow(dead_code)]
// pub fn sphere_cat_bvh() -> (geometry::Camera, BvhNode, Vec<Primitive>) {
...
// #[allow(dead_code)]
// pub fn basic_light() -> (geometry::Camera, BvhNode, Vec<Primitive>) {
//     let from: Point3<f64> = Point3::new(13., 2.,3.);
...
//     vec.push(Primitive::new_sphere(Point3::new(0., -1000., 0.), 1000., Arc::clone(&tex)));
//     vec.push(Primitive::new_sphere(Point3::new(0., 2., 0.), 2., Arc::clone(&tex)));

//     let light = Arc::new(Material::new_diffuse(Texture::new_solid_color(Vector3::new(1000., 1000., 1000.))));
//     vec.push(Primitive::new_xy_rect(3., 1., 5., 3., -2., Arc::clone(&light)));
//     vec.push(Primitive::new_sphere(Point3::new(0., 7., 0.), 2., Arc::clone(&light)));
...
// #[allow(dead_code)]
// pub fn cornell_box() -> (geometry::Camera, BvhNode, Vec<Primitive>) {
...
//     vec.push(Primitive::new_flip_face(Box::new(Primitive::new_yz_rect(0., 0., 555., 555., 555., Arc::clone(&green)))));
//     vec.push(Primitive::new_yz_rect(0., 0., 555., 555., 0., Arc::clone(&red)));
//     vec.push(Primitive::new_xz_rect(213., 227., 343., 332., 554.9, Arc::clone(&light)));
//     vec.push(Primitive::new_xz_rect(0., 0., 555., 555., 0., Arc::clone(&white)));
//     vec.push(Primitive::new_flip_face(Box::new(Primitive::new_xz_rect(0., 0., 555., 555., 555., Arc::clone(&white)))));
//     vec.push(Primitive::new_flip_face(Box::new(Primitive::new_xy_rect(0., 0., 555., 555., 555., Arc::clone(&white)))));
